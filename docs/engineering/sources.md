...
- typescript-eslint typed linting: https://typescript-eslint.io/getting-started/typed-linting/ — type-aware recommended rules with `projectService`; installed from the package registry with a genuine lockfile update.
