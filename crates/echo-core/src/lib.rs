...
pub mod physics;
pub mod room;
use balance::{Balance, Skin, Weapon};
...
pub struct Settings {
    ...
    pub mirror_cooldown_ms: u64, pub bunny_hop: BunnyHop, pub balance: Balance,
}
impl Default for Settings {
    fn default() -> Self { Self { delay_ms:rules().delay_ms, round_ms:rules().round_ms, seeker_count:2,
        map_id:MapId::Afterhours,reload_ms:rules().reload_ms,dash_cooldown_ms:3200,mirror_cooldown_ms:60000,
        bunny_hop:BunnyHop::Timed,balance:Balance::default() } }
}
impl Settings {
...
pub struct Input {
    ...
    pub crouch:bool,pub interact:bool,pub ability:bool,pub mine:bool,pub scan:bool,pub weapon:Option<Weapon>,
}
impl Input {
...
pub struct Motor {
    ...
    #[serde(default)] pub slide_time:f64, #[serde(default)] pub slide_cooldown:f64, #[serde(default)] pub crouch_held:bool,
    #[serde(default)] pub control_left:f64, #[serde(default)] pub pull_left:f64,
    #[serde(default)] pub pull_x:f64, #[serde(default)] pub pull_z:f64, #[serde(default)] pub pull_speed:f64,
}
impl Motor {
    pub fn new(p:Vec3)->Self {Self{x:p.x,y:p.y,z:p.z,vx:0.0,vy:0.0,vz:0.0,yaw:0.0,pitch:0.0,grounded:true,stamina:100.0,
        ...
        slide_time:0.0,slide_cooldown:0.0,crouch_held:false,control_left:0.0,pull_left:0.0,pull_x:0.0,pull_z:0.0,pull_speed:0.0}}
    pub fn position(&self)->Vec3 {Vec3{x:self.x,y:self.y,z:self.z}}
    pub fn controlled(&self)->bool {self.control_left>0.0||self.pull_left>0.0}
}
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all="camelCase")]
pub struct Pose {
    ...
    #[serde(default)] pub sliding:bool, #[serde(default)] pub shielded:bool, #[serde(default)] pub controlled:bool,
    #[serde(default)] pub hit_at:f64, #[serde(default)] pub skin:Skin, #[serde(default)] pub weapon:Weapon,
}
